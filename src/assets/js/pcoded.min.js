        ...
        $("body").hasClass("minimenu") ||
            ...
            $(".pc-navbar > li:not(.pc-caption)").on("click", function () {
                $(this).hasClass("pc-trigger")
                    ? ($(this).removeClass("pc-trigger"), $(this).children(".pc-submenu").slideUp("fast"))
                    : ($("li.pc-trigger").children(".pc-submenu").slideUp("fast"), $("li.pc-trigger").removeClass("pc-trigger"), $(this).addClass("pc-trigger"), $(this).children(".pc-submenu").slideDown("fast"));
            }),
            $(".pc-navbar > li:not(.pc-caption) li").on("click", function (e) {
                e.stopPropagation(),
                    $(this).hasClass("pc-trigger")
...
function collapseedge() {
    var e,
        a = $(window).height();
    $(window).width() > 1024 &&
        $(".minimenu .pc-sidebar .pc-submenu .pc-hasmenu").hover(
            function () {
                ...
                if (!(o + r <= a)) {
                    ...
                    s.addClass("scroll-menu"),
                        ...
                        (e = new PerfectScrollbar(".scroll-menu", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 }));
                }
            },
            function () {
...
if (
    ($(document).ready(function () {
        ...
        feather.replace(),
            ...
            $("#vertical-nav-toggle").on("click", function () {
               debugger; console.log("123"), $("body").hasClass("minimenu") ? ($("body").removeClass("minimenu"), menuclick()) : ($("body").addClass("minimenu"), $(".pc-navbar li:not(.pc-trigger) .pc-submenu").removeAttr("style"), collapseedge());
            }),
    ...
    $("body").hasClass("layout-topbar") &&
        $(".pc-header .list-unstyled > .dropdown").hover(
            function () {
    ...
    var hpx,
        ...
        docW = $(window).width();
    docW > 1024 &&
        $(".pc-horizontal .topbar .pc-submenu .pc-hasmenu").hover(
            function () {
                ...
                if ((s + o <= docW || e.addClass("edge"), !(i + r <= docH))) {
                    ...
                    e.addClass("scroll-menu"),
                        ...
                        (hpx = new PerfectScrollbar(".scroll-menu", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40 }));
                }
            },
            function () {
